...
def generate_flashcard(status):
    global new_word, flip_timer, words
    if status:
        try:
            ...
            new_data.to_csv("data/words_to _learn.csv", index=False)
